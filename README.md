...
| redis.hosts                            | true                                | Array\<string\|hash\> | n/a                       | list of Redis hosts; each entry is either a `host:port` string or a hash with `address`/`password`/`tls` or `url`                                                                                                                                                                                                                                                                                                                                                                                                                            |
| redis.hosts[].address                  | false                               | string                | n/a                       | Redis address including port, supports `${ENV_VAR}` interpolation                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| redis.hosts[].password                 | false                               | string                | n/a                       | Redis AUTH password, supports `${ENV_VAR}` interpolation (the variable must be set in the autoscaler pod)                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| redis.hosts[].tls                      | false                               | boolean               | false                     | connect over TLS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| redis.hosts[].url                      | false                               | string                | n/a                       | `redis://` or `rediss://` (TLS) URL, e.g. `rediss://:password@host:6379`, supports `${ENV_VAR}` interpolation; used instead of `address`/`password`/`tls`                                                                                                                                                                                                                                                                                                                                                                                    |
